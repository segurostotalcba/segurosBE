...
const obtenerYGuardarCarteraSancor = async (req, res) => {
    try {
        debugger;
        console.log("Obteniendo datos de cartera...");
        const responseCartera = await axios.get("http://localhost:9000/api/sancor", {
            params: {
                hoja: "Detalle",
                ssid: "184zvD0HPVoKzfXZOciCOJNZhWClDVrLp"
            },
...
module.exports = { obtenerYGuardarCarteraSancor };